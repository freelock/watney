...
module.exports = {
    ...
    getQuickStatus(room) {
        ...
        behat = status.test_behat && (status.test_behat == 1) ? '✔️' : '❌';
        wraith = status.test_wraith && (status.test_wraith == 1) ? '✔️' : '❌';
        ...
        return dirty + behat + wraith + release;
    },
