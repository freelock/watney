        ...
        if (content.msgtype == 'com.freelock.data') {
            ...
            switch(type) {
                case 'task':
                    ...
                    data.link = project.permalink + '/task/' + payload.data.id;
                    ...
                    if (action == 'change') {
                        ...
                        if (payload.change.comment && payload.change.comment.length) {
                          message += '<a href="{link}">Comment on {item}</a> by {by}: ' + payload.change.comment;
                        }
                    }
                ...
                case 'userstory':
                    ...
                    data.timer_name = timer_name;
                    data.project_id = project_id;
                    data.link = project.permalink + '/us/' + payload.data.id;
