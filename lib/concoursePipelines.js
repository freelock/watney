    ...
    concourseMessage: function(room, body, event) {
        ...
        if (content.msgtype === 'com.freelock.data') {
            let builddata = content.build,
                ...
                log, releaseDate, releaseNote, releaseGate,
                    ...
                    if (this.cleanRun) {
                        ...
                        switch (state) {
                            ...
                            case 'stage':
                                ...
                                releaseGate = container.getResult(container.roomsByAlias[alias]);
                                if (releaseDate) {
                                    this.sitesStage.push(alias + releaseGate + ' - ' + releaseNote + ' (release at: ' + releaseDate + ')');
                                } else {
                                    this.sitesStage.push(alias + releaseGate + ' - ' + releaseNote);
                                }
                                break;
                            case 'dev':
