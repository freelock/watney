...
module.exports = {
        ...
        container.roomList.forEach(function(room){
            ...
            if (state) {
                ...
                if (targetDate) {
                    ...
                    container.scheduledJobs[jobKey] = scheduler.scheduleJob(targetDate, this.notifyRelease.bind(this, room));
                }
            }
    ...
    notifyRelease: function(room){
        this.container.send(room, '<b>John: Release time reached!</b>');
    }
};