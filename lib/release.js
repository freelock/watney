...
module.exports = {
    ...
    updateVersion: function(topic, data) {
        ...
        if (!version && data.version) {
            ...
            container.setState(room.roomId, container.config.releaseName, props);
    ...
    postNotes: function(room) {
        this.releaseNotes(room, "markdown");
        setTimeout(this.createRelease.bind(this), 3000);

    },

    createRelease: function(room) {
        this.releaseNotes(room, 'create');
    },
