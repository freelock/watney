            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 44:
                        _context.prev = 44;
                        _context.next = 47;
                        return (0, _bluebird.resolve)(this._processSyncResponse(syncToken, data, isCachedResponse));
...
SyncApi.prototype._processSyncResponse = function () {
    var _ref2 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee4(syncToken, data, isCachedResponse) {
                        ...
                        return (0, _bluebird.resolve)(_bluebird2.default.mapSeries(joinRooms, function () {
                            var _ref3 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee3(joinObj) {
                                var processRoomEvent = function () {
                                    ...
                                    return function processRoomEvent(_x6) {
