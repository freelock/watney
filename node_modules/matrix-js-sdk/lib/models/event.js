...
_utils2.default.extend(module.exports.MatrixEvent.prototype, {
    ...
    _decryptionLoop: function () {
        var _ref2 = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee(crypto) {
            var res;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 22:
                            ...
                            console.log('Got error decrypting event (id=' + this.getId() + ': ' + (_context.t0.message + '), but retrying'));
                        ...
                        case 25:
                            ...
                            console.warn('Error decrypting event (id=' + this.getId() + '): ' + _context.t0);
