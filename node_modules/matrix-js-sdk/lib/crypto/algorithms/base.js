...
var DecryptionError = function (_Error) {
    ...
    (0, _createClass3.default)(DecryptionError, [{
        key: 'toString',
        value: function toString() {
            ...
            if (this.details) {
                result += ', ' + (0, _keys2.default)(this.details).map(function (k) {
...
var UnknownDeviceError = exports.UnknownDeviceError = function (_Error2) {
    ...
    function UnknownDeviceError(msg, devices) {
        ...
        var _this3 = (0, _possibleConstructorReturn3.default)(this, (UnknownDeviceError.__proto__ || (0, _getPrototypeOf2.default)(UnknownDeviceError)).call(this, msg));
