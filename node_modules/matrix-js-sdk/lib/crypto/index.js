...
Crypto.prototype.setRoomEncryption = function (roomId, config) {
    ...
    if (!existingConfig) {
        console.log("Enabling encryption in " + roomId + " for the first time; " + "invalidating device lists for all users therein");
        var room = this._clientStore.getRoom(roomId);
        var members = room.getJoinedMembers();
        members.forEach(function (m) {
            _this._deviceList.invalidateUserDeviceList(m.userId);
        });
    ...
    if (!syncData.oldSyncToken) {
        ...
        if (oldSyncToken !== null) {
            this._invalidateDeviceListsSince(oldSyncToken, nextSyncToken).catch(function (e) {
                ...
                _this4._invalidateDeviceListForAllActiveUsers();
            }).done(function () {
                _this4._initialDeviceListInvalidationDone = true;
...
Crypto.prototype._invalidateDeviceListsSince = function (oldSyncToken, lastKnownSyncToken) {
    ...
    return this._baseApis.getKeyChanges(oldSyncToken, lastKnownSyncToken).then(function (r) {
        ...
        var filteredUserIds = _this5._getE2eRoomMembers();
...
Crypto.prototype._invalidateDeviceListForAllActiveUsers = function () {
    ...
    Object.keys(this._getE2eRoomMembers()).forEach(function (m) {
        _this6._deviceList.invalidateUserDeviceList(m);
    });
};
